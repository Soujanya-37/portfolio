  ...
  <Section id="contact" title="Let's Connect!" icon={Mail} animate>
    <div className="max-w-lg mx-auto text-center bg-gray-800 p-8 rounded-xl shadow-2xl border border-blue-700/50">
      <p className="text-lg text-gray-300 mb-8">
        I'm always eager to collaborate on exciting projects and discuss new opportunities.
      ...
      <div className="mt-8 flex justify-center space-x-6">
        <a
          ...
          className="text-gray-400 hover:text-white transition-colors duration-200 transform hover:scale-125"
        >
